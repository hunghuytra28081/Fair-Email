package com.photo.fairemail.utils.popup;
...
import com.photo.fairemail.utils.CenteredImageSpan;
import com.photo.fairemail.utils.Helper;
import com.photo.fairemail.utils.SpannableStringBuilderEx;
...
public class PopupMenuLifecycle extends PopupMenu {
    ...
    public PopupMenuLifecycle(@NonNull Context context, LifecycleOwner owner, @NonNull View anchor) {
        ...
        Log.i("PopupMenuLifecycle","Instantiate " + this);

        owner.getLifecycle().addObserver(new LifecycleObserver() {
            @OnLifecycleEvent(Lifecycle.Event.ON_DESTROY)
            public void onDestroy() {
                Log.i("PopupMenuLifecycle","Destroy " + this);
    ...
    @Override
    public void show() {
        Log.i("PopupMenuLifecycle","Show " + this);
        try {
            super.show();
        } catch (Throwable ex) {
            Log.e("PopupMenuLifecycle",ex.toString());
        }
    }
