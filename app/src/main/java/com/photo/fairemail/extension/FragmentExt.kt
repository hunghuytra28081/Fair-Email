...
fun AppCompatActivity.replaceFragmentBackstack(frameId: Int, fragment: Fragment, backstack: String) {
    supportFragmentManager.inTransaction{replace(frameId, fragment).addToBackStack(backstack)}
}
