...
import com.photo.fairemail.utils.EntityLog;
import com.photo.fairemail.utils.Helper;
import com.photo.fairemail.utils.provider.EmailProvider;
    ...
    static Context getLocalizedContext(Context context) {
        ...
        try {
            ...
            if (language != null) {
                ...
                Log.i("AppExt","Set language=" + language + " locale=" + locale);
